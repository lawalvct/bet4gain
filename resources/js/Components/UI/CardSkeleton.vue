<template>
    ...
    >
        <!-- Header skeleton -->
        <div
            class="px-4 py-2.5 border-b border-surface-light-border dark:border-surface-dark-border flex items-center justify-between"
        >
        ...
        >
            ...
            >
                <SkeletonLoader v-if="avatar" width="24px" shape="circle" />
                <SkeletonLoader :width="randomWidth()" height="12px" />
                <SkeletonLoader width="50px" height="12px" class="ml-auto" />
            </div>
        </div>
    </div>
</template>
