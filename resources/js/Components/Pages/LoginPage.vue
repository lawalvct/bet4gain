                ...
                <div class="mt-6 space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button
                            ...
                            :key="account.email"
                            type="button"
                            @click="fillForm(account.email, account.password)"
                            class="flex items-center justify-center gap-2 py-3 px-4 border border-primary-500/20 bg-primary-500/5 rounded-xl hover:bg-primary-500/10 hover:border-primary-500/30 transition text-primary-600 dark:text-primary-400 font-medium active:scale-95"
                        >
                    ...
                    <a
                        href="/admin"
                        class="flex items-center justify-center gap-2 py-3 px-4 border border-amber-500/20 bg-amber-500/5 rounded-xl hover:bg-amber-500/10 hover:border-amber-500/30 transition text-amber-600 dark:text-amber-400 font-medium active:scale-95"
                    >
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const quickAccounts = [
    {
        label: "Player 1",
        email: "player1@example.net",
        password: "password",
    },
    {
        label: "Player 2",
        email: "player2@example.net",
        password: "password",
    },
];
